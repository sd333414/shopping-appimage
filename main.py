...
db= ssm.get_parameter(Name='DB', WithDecryption=True)
...
v1=db_host['Parameter']['Value']
v2=db_uname['Parameter']['Value']
v3=db_pwd['Parameter']['Value']
v4=db['Parameter']['Value']

app.config['MYSQL_DATABASE_USER'] = v2
app.config['MYSQL_DATABASE_PASSWORD'] = v3
app.config['MYSQL_DATABASE_DB'] = v4
app.config['MYSQL_DATABASE_HOST'] = v1
